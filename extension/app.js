...
exports.bindEvents = exports.renderTimerFirstTime = exports.renderTimer = undefined;
...
var renderTimerFirstTime = exports.renderTimerFirstTime = function renderTimerFirstTime() {
  (0, _tracker.readLimits)(function (limits) {
    var submitInput = document.getElementById("time-limit-input");
...
var bindEvents = exports.bindEvents = function bindEvents() {
  var submitBtn = document.getElementById("submit-time-limit");
...
function persistLimits() {
  var TRACKER_STORAGE_LIMITS = "youtube_time_tracker_limits";

  var limitsInHours = document.getElementById('time-limit-input').value;
  var limitsInMinutes = limitsInHours * 60;

  chrome.storage.local.set(_defineProperty({}, TRACKER_STORAGE_LIMITS, limitsInMinutes), function () {
    (0, _log.log)('YouTube Time Tracker limit is set to:');
    (0, _log.log)(limitsInMinutes);
  });
}
...
exports.incrementTime = exports.blockSiteWithCover = exports.readLimits = exports.readData = undefined;
...
var readLimits = exports.readLimits = function readLimits(callback) {
  chrome.storage.local.get([TRACKER_STORAGE_LIMITS], function (result) {
    (0, _log.log)('YouTube Time Tracker limit read as:');
    (0, _log.log)(result);

    var limits = result[TRACKER_STORAGE_LIMITS];

    callback(limits);
  });
};

var blockSiteWithCover = exports.blockSiteWithCover = function blockSiteWithCover(limits, timeToday) {
